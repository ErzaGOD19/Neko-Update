...
Persistent State Persistence: The system tracks and remembers the last update check timestamp across system reboots.
...
Enable and start the service simultaneously:
